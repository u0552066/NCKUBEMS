package com.example.jason.nckubems.Schedule;
...
import com.example.jason.nckubems.JsonStr;
...
public class EssHistoryFragment extends DialogFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        btnNow.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getESSHistoryChart("getHistoryInNow", Integer.valueOf(date[0]), Integer.valueOf(date[1])-1, Integer.valueOf(date[2]));
            }
        });
        btnNow.callOnClick();
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        getESSHistoryChart("getHistoryInDay", year, month, day);
                    }
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        txtTime.setText(format);
                        txtTime.setVisibility(View.VISIBLE);
                        getESSHistoryChart("getHistoryInMonth", year, month, 0);
                    }
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        txtTime.setText(format);
                        txtTime.setVisibility(View.VISIBLE);
                        getESSHistoryChart("getHistoryInYear", year, 0, 0);
                    }
    ...
    public void getESSHistoryChart(final String button, int year, int month, int day) {
        ...
        switch (button) {
            ...
            Objectrequest = new StringRequest(Request.Method.POST, ess, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ArrayList<ChartItem> list = new ArrayList<ChartItem>(), list2 = new ArrayList<ChartItem>(), list3 = new ArrayList<ChartItem>();
                    ArrayList<BarEntry> BarEntries = new ArrayList<BarEntry>();
                    ArrayList<Entry> LineEntries = new ArrayList<Entry>(), LineSOC = new ArrayList<Entry>();
                    ArrayList<String> array = new ArrayList<String>();
                    String[] Chart_id = {"Energy"}, Chart_id2 = {"Power"}, Chart_id3 = {"SOC"};
                    try {
                        JSONObject object = null;
                        object = new JSONObject(response);
                        Log.d("getESSHistoryChart", response.toString());
                        ...
                        for (int i = 0; i < num; i++) {
                            ...
                            BarEntries.add(new BarEntry(i, Float.parseFloat(energy)));
                            LineEntries.add(new Entry(i, Float.parseFloat(power)));
                            LineSOC.add(new Entry(i, Float.parseFloat(soc)));
                        ...
                        switch (button) {
                            case "getHistoryInYear":
                                ...
                                list.add(new BarChartItem(chart.generateDataBar(Chart_id, BarEntries), getActivity(), "累計發電量", array, "kWh", "時間(月份)"));
                                break;
                            case "getHistoryInMonth":
                                lv2.setVisibility(View.GONE);
                                lv3.setVisibility(View.GONE);
                                list.add(new BarChartItem(chart.generateDataBar(Chart_id, BarEntries), getActivity(), "累計發電量", array, "kWh", "時間(日)"));
                                break;
                            case "getHistoryInDay":
                                lv2.setVisibility(View.GONE);
                                lv3.setVisibility(View.GONE);
                                list.add(new BarChartItem(chart.generateDataBar(Chart_id, BarEntries), getActivity(), "累計發電量", array, "kWh", "時間(小時)"));
                                break;
                            case "getHistoryInNow":
                                lv2.setVisibility(View.VISIBLE);
                                lv3.setVisibility(View.VISIBLE);
                                list.add(new BarChartItem(chart.generateDataBar(Chart_id, BarEntries), getActivity(), "累計發電量", array, "kWh", "時間(時:分)"));
                                list2.add(new LineChartItem(chart.generateDataLine(Chart_id2, LineEntries), getActivity(), "實功 (kWh)", array, "kW", "時間(時:分)"));
                                list3.add(new LineChartItem(chart.generateDataLine(Chart_id3, LineSOC), getActivity(), "SOC (%)", array, "%", "時間(時:分)"));
                                break;
                        }
