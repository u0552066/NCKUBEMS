...
public class HvFragment extends DialogFragment {
    ...
    private String hv = "xlii_bems_api/microgrid.php";
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        int Comparesurl = hv.indexOf("//");
        chart = new Chart(getActivity());
        if(Comparesurl == -1) {
            hv = ip + hv;
            hv = "http://59.125.180.237/xlii_bems_api/microgrid.php";
        ...
        btnNow.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getHvHistoryChart("getHistoryInNow", Integer.valueOf(date[0]), Integer.valueOf(date[1])-1, Integer.valueOf(date[2]));
            }
        });
        btnNow.callOnClick();
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        getHvHistoryChart("getHistoryInDay", year, month, day);
                    }
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        txtTime.setText(format);
                        txtTime.setVisibility(View.VISIBLE);
                        getHvHistoryChart("getHistoryInMonth", year, month, 0);
                    }
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        txtTime.setText(format);
                        txtTime.setVisibility(View.VISIBLE);
                        getHvHistoryChart("getHistoryInYear", year, 0, 0);
                    }
    ...
    public void getHvHistoryChart(final String button, int year, int month, int day) {
        ...
        switch (button) {
            ...
            Objectrequest = new StringRequest(Request.Method.POST, hv, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Log.d("getHvHistoryChart", response.toString());
                        ...
                        switch (button) {
                            case "getHistoryInYear":
                                list.add(new BarChartItem(chart.generateDataBar(Chart_id, BarEntries), getActivity(), "累積供電量", array, "kWh", "時間(月份)"));
                                break;
                            case "getHistoryInMonth":
                                list.add(new BarChartItem(chart.generateDataBar(Chart_id, BarEntries), getActivity(), "累積供電量", array, "kWh", "時間(日)"));
                                break;
                            case "getHistoryInDay":
                                list.add(new BarChartItem(chart.generateDataBar(Chart_id, BarEntries), getActivity(), "累積供電量", array, "kWh", "時間(小時)"));
                                break;
                            case "getHistoryInNow":
                                list.add(new LineChartItem(chart.generateDataLine(Chart_id,  LineEntries), getActivity(), "即時供電輸出", array, "kW", "時間(時:分)"));
                                break;
                        }
